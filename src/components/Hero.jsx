      ...
      <div className={`container ${styles.content}`}>
        <div className={styles.textSide}>
          ...
          <h1 className={styles.heading}>
            Hi, I&apos;m{' '}
            <span className={styles.name}>Mohamed gamal</span>
          </h1>
          ...
          <p className={styles.desc}>
            A skilled Front-End Developer with a proven track record of developing innovative web designs and features. 
Good knowledge of HTML, CSS, JavaScript, Bootstrap, and some other technologies such as React, Redux, and 
with the ability to quickly learn new technologies and work within a team to obtain the highest quality projects 
          </p>
          ...
          <div className={styles.socials}>
            <a href="https://github.com/mohammedgamal2022" target="_blank" rel="noreferrer" className={styles.socialIcon} aria-label="GitHub">
            ...
            <a href="https://wa.me/+201110405092" target="_blank" rel="noreferrer" className={styles.socialIcon} aria-label="WhatsApp">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="http://www.linkedin.com/in/omar-mohamed-9220411b4" target="_blank" rel="noreferrer" className={styles.socialIcon} aria-label="LinkedIn">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className={styles.visualSide}>
          <div className={styles.avatarWrapper}>
            ...
            <div className={styles.avatar}>
              <img src="/images/profile_photo.jpg" alt="Mohamed gamal - Web Developer" className={styles.avatarImage} />
            </div>
