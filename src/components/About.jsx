      ...
      <div className="container">
        <div className={styles.grid}>
          <div className={styles.left}>
            <div className={styles.imgFrame}>
              <div className={styles.imgInner}>
                <img src="/images/profile_photo.jpg" alt="Mohammed Gamal- Profile" className={styles.imgContent} />
          ...
          <div className={styles.right}>
            ...
            <p className={styles.bio}>
              Based in Giza, Egypt. I focus on delivering clean code and exceptional user experiences,
            ...
            <div className={styles.infoGrid}>
              <div className={styles.infoItem}>
                ...
                <div>
                  ...
                  <span className={styles.infoValue}>Giza, Egypt</span>
                </div>
              </div>
              <div className={styles.infoItem}>
                <span className={styles.infoIcon}>💼</span>
              ...
              <div className={styles.infoItem}>
                ...
                <div>
                  ...
                  <span className={styles.infoValue}> faculty of commerce</span>
                </div>
              </div>
              <div className={styles.infoItem}>
                <span className={styles.infoIcon}>🌐</span>
            ...
            <a href='/cv/Frontend_mohamed_gamal.pdf' target='_blank' className={styles.downloadBtn}>
